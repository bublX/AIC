...
void Graphics(const char * ftname)
{
    ...
    int result = system("gnuplot -p -e \"set title 'Sort'; set xlabel 'Size'; set ylabel 'Times (sec)'; plot 'data.txt' using 1:2 with linespoints title 'Sort'\"");
